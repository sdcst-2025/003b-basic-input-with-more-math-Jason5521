...
(2 points) 
"""
principal =float(input("Please enter the amount of principal."))
Days =float(input("Please enter the days in the month."))
rate = float(input("Please enter the rate.")) / 100
